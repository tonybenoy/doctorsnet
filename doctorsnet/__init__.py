...
if app_db.is_file() == False:
    ...
    c =conn.cursor()
    c.execute('''CREATE TABLE user (last_seen text, username text UNIQUE NOT NULL,id integer PRIMARY KEY AUTOINCREMENT,about text ,hashedpass text,email text )''')
